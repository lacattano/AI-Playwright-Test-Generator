...
LAYER_MAP = {
    ...
    "src/pipeline_artifact_manager.py": "orchestration",
    "src/journey_models.py": "orchestration",
    "src/prerequisite_injector.py": "orchestration",
    "src/test_structure_assembler.py": "orchestration",
    "src/skip_manager.py": "orchestration",
    # Intelligence
    ...
    "src/prompt_builder.py": "intelligence",
    "src/test_table.py": "intelligence",
    "src/skeleton_validator.py": "intelligence",
    "src/section_scoper.py": "intelligence",
    "src/rag_store.py": "intelligence",
    "src/rag_bundled.py": "intelligence",
    "src/rag_retriever.py": "intelligence",
    "src/rag_learn.py": "intelligence",
    "src/flow_memory.py": "intelligence",
    "src/pdf_ingest.py": "intelligence",
    "src/ocr_backends.py": "intelligence",
    "src/element_enricher.py": "intelligence",
    "src/vision_enricher.py": "intelligence",
    # Context
    "src/scraper.py": "context",
    "src/stateful_scraper.py": "context",
    "src/journey_scraper.py": "context",
    "src/journey_subprocess.py": "context",
    "src/journey_executor.py": "context",
    "src/journey_enrichment.py": "context",
    "src/journey_auth_detector.py": "context",
    "src/cart_seeding_scraper.py": "context",
    "src/accessibility_enricher.py": "context",
    "src/aria_parser.py": "context",
    "src/form_detector.py": "context",
    "src/browser_utils.py": "context",
    "src/form_login_utils.py": "context",
    "src/hover_click_utils.py": "context",
    "src/role_mapper.py": "context",
    # Refinement
    ...
    "src/locator_repair.py": "refinement",
    "src/locator_builder.py": "refinement",
    "src/intent_matcher.py": "refinement",
    "src/element_matcher.py": "refinement",
    "src/placeholder_scorers.py": "refinement",
    "src/semantic_matcher.py": "refinement",
    "src/semantic_candidate_ranker.py": "refinement",
    "src/url_inference.py": "refinement",
    "src/url_resolver.py": "refinement",
    "src/code_normalizer.py": "refinement",
    "src/llm_reasoning_filter.py": "refinement",
    "src/self_healing.py": "refinement",
    "src/failure_classifier.py": "refinement",
    "src/pom_helpers.py": "refinement",
    # Output
    ...
    "src/failure_reporter.py": "output",
    "src/evidence_serializer.py": "output",
    "src/screenshot_capture.py": "output",
    "src/evidence_loader.py": "output",
    "src/evidence_index.py": "output",
    "src/evidence_export.py": "output",
    "src/export_service.py": "output",
    "src/run_history_chart.py": "output",
    "src/run_history_cli.py": "output",
    "src/artifact_validation.py": "output",
    "src/heatmap_alignment.py": "output",
    # Utility
    ...
    "src/settings_store.py": "utility",
    "src/storage.py": "utility",
    "src/secure_config.py": "utility",
    "src/provider_config.py": "utility",
    "src/sqlite_persistence.py": "utility",
    "src/run_result_persistence.py": "utility",
