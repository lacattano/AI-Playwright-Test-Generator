...
class HomePage:
    """Page Object for https://automationexercise.com/. Scraped elements: 157."""
    ...
    def click_api_testing(self) -> None:
        self.page.locator('a[href="/api_list"]').first.click()
    ...
    def click_apis_list_for_practice(self) -> None:
        self.page.locator('a[href="/api_list"]').first.click()
