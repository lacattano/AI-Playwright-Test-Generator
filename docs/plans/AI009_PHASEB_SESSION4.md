...
- [ ] `TestOrchestrator` accepts `journey_steps` parameter
- [ ] Journey data merges with static scrape data (doesn't replace)
- [ ] End-to-end test on saucedemo.com captures authenticated pages
- [ ] No auth redirect errors in saucedemo.com test
- [ ] UAT script runs without errors
- [ ] `ruff check src/` → clean
- [ ] `mypy src/` → clean
- [ ] `pytest tests/ -v` → all pass
- [ ] BACKLOG.md updated — AI-009 Phase B marked COMPLETE
- [ ] docs/ARCHITECTURE.md updated with journey scraping section
