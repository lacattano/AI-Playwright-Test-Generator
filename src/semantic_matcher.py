...
class SemanticMatcher:
    ...
    TOKEN_EXPANSIONS: dict[str, set[str]] = {
        ...
        "sign": {"login", "signin", "sign-in", "logon", "authenticate"},
        "signin": {"login", "sign", "sign-in", "logon", "authenticate"},
        "signup": {"sign-up", "register", "create", "account", "up"},
        "sign-up": {"signup", "register", "create", "account", "up"},
        "register": {"signup", "sign-up", "create", "account", "up"},
        "up": {"signup", "sign-up", "register", "create", "account"},
        "logout": {"sign-out", "signout", "log off", "exit", "sign out", "out"},
        "sign-out": {"logout", "signout", "log off", "exit", "sign out", "out"},
        "signout": {"logout", "sign-out", "log off", "exit", "sign out", "out"},
        "out": {"logout", "sign-out", "signout", "log off", "exit"},
        "authenticate": {"login", "sign", "signin", "auth", "verify"},
