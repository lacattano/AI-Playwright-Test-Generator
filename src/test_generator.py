...
class TestGenerator:
    ...
    def _ensure_output_dir(self) -> None:
        ...
        try:
            ...
            raise PermissionError(f"Write permission denied for output directory: {self.output_dir}")
        except OSError as e:
            raise OSError(f"Failed to create/access output directory {self.output_dir}: {e}")
