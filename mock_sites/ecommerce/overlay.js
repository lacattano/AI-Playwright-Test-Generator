/*
 * Injectable consent/ad overlay for the e-commerce mock (B-029 race).
 *
 ...
 * `#google_vignette`, `#consent-root`), so the B-029 class — a click on the
 * cart link being swallowed by an overlay, with no navigation — is testable
