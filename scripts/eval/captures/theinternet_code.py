...
def test_01_navigate_to_main_page(page: Page, evidence_tracker: EvidenceTracker) -> None:
...
def test_02_click_javascript_alerts_link(page: Page, evidence_tracker: EvidenceTracker) -> None:
    evidence_tracker.navigate("https://the-internet.herokuapp.com")
    dismiss_consent_overlays(page)
...
def test_03_click_for_js_alert_button(page: Page, evidence_tracker: EvidenceTracker) -> None:
...
def test_04_accept_javascript_alert_popup(page: Page, evidence_tracker: EvidenceTracker) -> None:
    evidence_tracker.navigate("https://the-internet.herokuapp.com/javascript_alerts")
    dismiss_consent_overlays(page)
    evidence_tracker.click('button:has-text("Click for JS Alert")', label="Click for JS Alert")
...
def test_05_verify_result_message(page: Page, evidence_tracker: EvidenceTracker) -> None:
    evidence_tracker.navigate("https://the-internet.herokuapp.com/javascript_alerts")
    dismiss_consent_overlays(page)
    evidence_tracker.click('button:has-text("Click for JS Alert")', label="Click for JS Alert")
    evidence_tracker.assert_visible("#result", label="result message text")
