...
class HomePage:
    ...
    def click_accepted_usernames_are_standard_user_locked_out_user_problem_user_performance_glitch_user_error_user_visual_user_password_for_all_users_secret_sauce(
        self,
    ) -> None:
        self.tracker.click(
            '[data-test="login-container"]',
            label="accepted usernames are standard user locked out user problem user performance glitch user error user visual user password for all users secret sauce",
        )

    def click_accepted_usernames_are_standard_user_locked_out_user_problem_user_performance_glitch_user_error_user_visual_user(
        self,
    ) -> None:
        self.tracker.click(
            "#login_credentials",
            label="accepted usernames are standard user locked out user problem user performance glitch user error user visual user",
        )
