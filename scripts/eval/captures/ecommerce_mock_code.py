...
def test_03_verify_added_confirmation(page: Page, evidence_tracker):
    evidence_tracker.navigate('http://localhost:8781/index.html')
    evidence_tracker.click('.add-to-cart.btn[data-product-id="1"]', label='Add to cart')
    evidence_tracker.assert_visible('p.text-center', label='product added confirmation')
...
def test_05_verify_cart_product_details(page: Page, evidence_tracker):
    ...
    evidence_tracker.click('.add-to-cart.btn[data-product-id="1"]', label='Add to cart')
    evidence_tracker.click('a[href="/cart.html"]', label='Cart link')
    evidence_tracker.assert_visible('p.cart_price', label='product name and price')
