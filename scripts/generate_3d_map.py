...
IMPORT_LINKS = [
    ...
    # New modules from recent splits
    ("src/orchestrator.py", "src/analyzer.py"),
    ("src/orchestrator.py", "src/config.py"),
    ("src/orchestrator.py", "src/code_postprocessor.py"),
    ("src/orchestrator.py", "src/url_utils.py"),
