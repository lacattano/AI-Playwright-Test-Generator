...
ROOT_CONFIG_FILES = [
    ".clinerules", ".clineignore", ".dockerignore", ".gitignore",
    ".env.example", ".python-version", "pyproject.toml",
    "pytest.ini", "requirements.txt", "Dockerfile",
    "docker-compose.yml", "LICENSE", "fix.sh",
    "launch_ui.sh", "launch_dev.sh",
]
...
DOC_REFS = {
    "AGENTS.md": [
        "streamlit_app.py", "cli/main.py", "src/test_generator.py",
        "src/llm_client.py", "src/orchestrator.py", "src/placeholder_resolver.py",
        "src/skeleton_parser.py", "src/scraper.py", "src/page_object_builder.py",
        "src/semantic_candidate_ranker.py", "src/pipeline_report_service.py",
        "src/pipeline_run_service.py", "src/pipeline_writer.py", "src/file_utils.py",
        "src/stateful_scraper.py", "src/code_validator.py", "src/run_utils.py",
        "src/gantt_utils.py", "src/heatmap_utils.py", "main.py", "README.md",
        "BACKLOG.md", "src/prompt_utils.py", "src/spec_analyzer.py",
        "src/pipeline_models.py", "tests/test_spec_analyzer.py",
        "tests/test_test_plan.py", "tests/test_evidence_tracker.py",
        "tests/test_gantt_utils.py", "tests/test_heatmap_utils.py",
        "generated_tests/conftest.py",
    ],
    "docs/ARCHITECTURE.md": [
        "src/orchestrator.py", "src/test_generator.py", "src/llm_client.py",
        "src/scraper.py", "src/placeholder_resolver.py", "src/skeleton_parser.py",
        "src/page_object_builder.py", "src/pipeline_writer.py",
        "src/pipeline_report_service.py", "streamlit_app.py", "cli/main.py",
        "src/prompt_utils.py",
    ],
    "BACKLOG.md": [
        "src/prompt_utils.py", "src/evidence_tracker.py",
        "src/orchestrator.py", "tests/conftest.py",
    ],
    "CHANGELOG.md": [
        "streamlit_app.py", "src/orchestrator.py", "src/test_generator.py",
        "src/scraper.py", "src/placeholder_resolver.py", "src/skeleton_parser.py",
        "src/page_object_builder.py", "src/pipeline_writer.py",
    ],
    "CONTRIBUTING.md": [
        "streamlit_app.py", "cli/main.py", "src/test_generator.py",
        "src/llm_client.py", "src/orchestrator.py", "pytest.ini", "pyproject.toml",
    ],
    "docs/DEMO_GUIDE.md": [
        "streamlit_app.py", "launch_ui.sh", "launch_dev.sh",
        "src/scraper.py", "src/test_generator.py",
    ],
    "docs/FEATURE_SPEC_AI009_phase_b.md": [
        "streamlit_app.py", "src/llm_client.py",
        "src/test_generator.py", "main.py", "fix.sh",
    ],
    "docs/specs/FEATURE_SPEC_intelligent_scraping_pipeline.md": [
        "streamlit_app.py", "src/prompt_utils.py", "src/skeleton_parser.py",
        "src/page_object_builder.py", "src/placeholder_resolver.py",
    ],
    "docs/specs/FEATURE_SPEC_multi_page_scraping.md": [
        "src/scraper.py", "src/stateful_scraper.py", "src/page_context_scraper.py",
        "src/orchestrator.py", "src/test_generator.py", "src/placeholder_resolver.py",
        "src/page_object_builder.py", "streamlit_app.py",
    ],
    "docs/specs/FEATURE_SPEC_multi_provider_llm.md": [
        "src/llm_client.py", "src/test_generator.py", "main.py",
        "src/llm_providers/__init__.py", "streamlit_app.py",
    ],
    "docs/specs/FEATURE_SPEC_page_context_scraper.md": [
        "src/scraper.py", "src/stateful_scraper.py", "src/orchestrator.py",
        "src/test_generator.py", "src/placeholder_resolver.py",
        "src/page_object_builder.py", "streamlit_app.py",
    ],
    "docs/specs/FEATURE_SPEC_run_results.md": [
        "src/pipeline_report_service.py", "src/report_utils.py",
        "src/pytest_output_parser.py", "src/coverage_utils.py",
        "streamlit_app.py", "src/pipeline_writer.py",
    ],
    "docs/session_02_placeholder_resolver.md": [
        "src/scraper.py", "src/placeholder_resolver.py",
        "src/orchestrator.py", "src/skeleton_parser.py",
    ],
    "docs/session_03_orchestrator.md": [
        "src/orchestrator.py", "src/scraper.py", "src/placeholder_resolver.py",
    ],
    "docs/session_04_final_polish.md": ["src/orchestrator.py"],
    "docs/session_05_pipeline_rebuild_plan.md": [
        "docs/specs/FEATURE_SPEC_intelligent_scraping_pipeline.md",
        "src/pipeline_models.py", "src/skeleton_parser.py",
        "src/page_object_builder.py", "src/placeholder_resolver.py",
        "src/test_generator.py", "src/scraper.py", "streamlit_app.py",
    ],
    "docs/test_suite_audit_2026-04-08.md": [
        "tests/test_orchestrator.py", "tests/test_skeleton_parser.py",
        "tests/test_placeholder_resolver.py", "tests/test_scraper.py",
        "tests/test_page_object_builder.py", "tests/test_pipeline_models.py",
        "tests/test_pipeline_writer.py", "tests/test_pipeline_run_service.py",
        "tests/test_pipeline_report_service.py", "tests/test_pytest_output_parser.py",
        "tests/test_run_utils.py", "tests/test_coverage_utils.py",
        "tests/test_user_story_parser.py", "tests/test_code_validator.py",
        "tests/test_test_generator.py", "tests/test_llm_client.py",
        "tests/test_llm_errors.py", "tests/test_cli_smoke.py",
        "tests/test_cli_test_orchestrator.py",
        "src/orchestrator.py", "src/skeleton_parser.py",
        "src/placeholder_resolver.py", "src/scraper.py",
        "src/page_object_builder.py", "src/pipeline_models.py",
        "src/pipeline_writer.py", "src/pipeline_run_service.py",
        "src/pipeline_report_service.py", "src/pytest_output_parser.py",
        "src/run_utils.py", "src/coverage_utils.py", "src/user_story_parser.py",
        "src/code_validator.py", "src/test_generator.py",
        "src/llm_client.py", "src/llm_errors.py",
    ],
    "docs/plans/AI-016_plan.md": [
        "src/spec_analyzer.py", "tests/test_spec_analyzer.py",
        "streamlit_app.py", "src/prompt_utils.py",
    ],
    "docs/plans/AI-017_plan.md": [
        "src/test_plan.py", "tests/test_test_plan.py", "streamlit_app.py",
    ],
    "docs/plans/AI-018_plan.md": [
        "src/evidence_tracker.py", "tests/test_evidence_tracker.py",
        "generated_tests/conftest.py", "./.gitignore",
    ],
    "docs/plans/AI-019_plan.md": [
        "src/prompt_utils.py", "src/llm_client.py", "src/test_generator.py",
    ],
    "docs/plans/AI-020_plan.md": ["src/report_utils.py", "streamlit_app.py"],
    "docs/plans/AI-021_plan.md": [
        "src/gantt_utils.py", "tests/test_gantt_utils.py", "streamlit_app.py",
    ],
    "docs/plans/AI-022_plan.md": [
        "src/heatmap_utils.py", "tests/test_heatmap_utils.py", "streamlit_app.py",
    ],
    "docs/plans/AI0IS9_section1_audit.md": [
        "tests/conftest.py", "src/prompt_utils.py", "src/orchestrator.py",
    ],
    ...
    "docs/plans/AI019_section3_validation.md": [
        "src/test_generator.py", "src/orchestrator.py",
    ],
    "docs/plans/FEATURE_COMPLETION_CHECKLIST.md": [
        "docs/plans/AI-016_plan.md", "docs/plans/AI-017_plan.md",
        "docs/plans/AI-018_plan.md", "docs/plans/AI-019_plan.md",
        "docs/plans/AI019_section1_audit.md", "docs/plans/AI019_section2_prompts.md",
        "docs/plans/AI019_section3_validation.md",
        "docs/plans/AI-020_plan.md", "docs/plans/AI-021_plan.md",
        "docs/plans/AI-022_plan.md",
        "docs/archived/session_05_pipeline_rebuild_plan.md",
        "src/test_plan.py", "streamlit_app.py",
        "src/page_object_builder.py", "src/placeholder_resolver.py",
    ],
    "docs/plans/PK_CLEANUP_section1_audit.md": [
        "docs/PROJECT_KNOWLEDGE.md", "AGENTS.md", "./.clinerules",
    ],
    "SECURITY.md": ["README.md", "CONTRIBUTING.md"],
    "docs/plans/FEATURE_PLAN_keyword_based_url_resolution.md": [
        "src/orchestrator.py", "src/url_utils.py", "src/placeholder_orchestrator.py",
    ],
    "docs/plans/FEATURE_PLAN_pom_with_evidence_tracker.md": [
        "src/page_object_builder.py", "src/evidence_tracker.py", "src/pipeline_writer.py",
    ],
    "docs/plans/FEATURE_PLAN_test_prerequisite_injection.md": [
        "src/orchestrator.py", "src/prerequisite_injector.py", "src/pipeline_writer.py",
    ],
    "docs/specs/FEATURE_SPEC_AI023_locator_repair.md": [
        "src/code_postprocessor.py", "src/placeholder_resolver.py",
        "src/locator_scorer.py",
    ],
    "docs/specs/FEATURE_SPEC_AI024_accessibility_tree_enrichment.md": [
        "src/scraper.py", "src/accessibility_enricher.py", "src/placeholder_resolver.py",
    ],
    "docs/specs/FEATURE_SPEC_AI026_persist_generated_tests.md": [
        "src/pipeline_writer.py", "src/file_utils.py", "src/pipeline_run_service.py",
    ],
...
for fpath in sorted(ALL_FILES):
    ...
    if fpath.endswith(".md"):
        ...
        ".clinerules", ".dockerignore", ".gitignore",
        "docker-compose.yml", "Dockerfile", ".env", ".env.example",
        ".python-version", ".clineignore", "pyproject.toml",
        "pytest.ini", "requirements.txt", "SECURITY.md",
        "LICENSE", "fix.sh", "launch_ui.sh", "launch_dev.sh",
    ):
        group = "Configuration"
