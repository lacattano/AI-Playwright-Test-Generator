...
class TestGenerator:
    ...
    def generate_and_save(self, user_request: str, page_context: PageContext | None = None) -> str:
        """
        ...
        try:
            ...
            if self.page_url:
                ...
                if page_context:
                    ...
                    print(f"⚠️  Warning: Failed to scrape page: {scrape_error}")
            ...
            code = self.client.generate_test(prompt_with_context)
